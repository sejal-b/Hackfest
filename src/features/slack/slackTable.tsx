...
import {SlackTableHeaders} from "src/consts/enums/placeholders.const";
            ...
            <DetailsTable>
                <Table className="border-collapse border border-slate-400 ...">
                    ...
                    <Tr className="bg-gray-50">
                        <th className="border border-slate-300 px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{SlackTableHeaders.MESSAGES}</th>
